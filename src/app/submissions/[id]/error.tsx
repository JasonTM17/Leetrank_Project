...
export default function SubmissionDetailError({
  ...
  useEffect(() => {
    console.error("[/submissions/[id]]", error);
  }, [error]);
    ...
    <>
      ...
      <main id="main-content" className="flex-1 flex items-center justify-center px-4 py-16" role="alert" aria-live="assertive">
        <div className="text-center max-w-md animate-fade-in-up">
          ...
          <h1 className="mt-4 text-2xl font-bold">Couldn&apos;t load submission</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            {error.message || "Something went wrong loading this submission."}
          </p>
          {error.digest && (
