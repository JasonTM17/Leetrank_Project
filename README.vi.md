...
- **Bộ chấm Go** chạy trong sandbox, hard time limit, blocklist theo từng ngôn ngữ.
- **15 ngôn ngữ**: Python, Go, Rust, Java, C/C++, Kotlin, JavaScript/TypeScript, Ruby, Swift, PHP, C#, Scala, Bash.
...
| `auth-go` | Identity + JWT issuer | Go, jose/JWKS, Postgres |
| `judge` | Bộ chấm bài sandbox | Go, runner contract, Redis queue |
...
Cần Node.js 20.x, pnpm 9, Postgres 16 và Redis 7 chạy local.
